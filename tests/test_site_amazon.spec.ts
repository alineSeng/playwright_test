...
// Test case 1 : Verify account creation with valid email

// Step 1: Open the browser and navigate to amazon.fr

// Step 2: Click on "Create Account" and fill in a valid email and required details

// Expected Result: Verify that the account is successfully created

// test('Verify account creation with valid email', async ({ page }) => {
//   const homePage = new Home_Page(page);
//   const registerPage = new Register_Page(page); 
//   // Step 1: Navigate to amazon.fr
//   await homePage.navigate();
//   await homePage.accept_cookies();
//   // Step 2: Create an account with valid email
//   // Expected Result: Verify that the account is successfully created
//   await registerPage.go_to_register_page();
//   await registerPage.register_with_fake_email();
// });
 
// Test case 2 : Verify account creation with invalid email

// Step 1: Open the browser and navigate to amazon.fr

// Step 2: Click on "Create Account" and fill in an invalid email and required details

// // Expected Result: Verify that an error message is displayed
// test('Verify account creation with invalid email', async ({ page }) => {
//   const homePage = new Home_Page(page);
//   const registerPage = new Register_Page(page); 
//   // Step 1: Navigate to amazon.fr
//   await homePage.navigate();
//   await homePage.accept_cookies();
//   // Step 2: Create an account with invalid email
//   // Expected Result: Verify that an error message is displayed
//   await registerPage.go_to_register_page();
//   await registerPage.register_with_fake_email();
// });
...
// Step 2: Click on "Sign In" and enter valid credentials

// Expected Result: Verify that the user is successfully logged in
...
// Step 2: Click on "Sign In" and enter invalid credentials
